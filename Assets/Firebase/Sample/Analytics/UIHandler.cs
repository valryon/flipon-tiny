...
namespace Firebase.Sample.Analytics
{
	...
	{
		public static GUISkin fb_GUISkin;
		private static Vector2 controlsScrollViewVector = Vector2.zero;
		...
		public static void AnalyticsProgress()
		{
		...
		public static void AnalyticsScore()
		{
		...
		public static void AnalyticsGroupJoin()
		{
		...
		static void GUIDisplayControls()
		{
			if (UIEnabled)
			{
